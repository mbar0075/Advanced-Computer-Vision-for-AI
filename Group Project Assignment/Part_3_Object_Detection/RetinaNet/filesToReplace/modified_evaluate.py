...
def main(args=None):
    ...
    if args.dataset_type == 'coco':
        ...
        average_precisions, inference_time, precision_recall = evaluate(
            generator,
            model,
        ...
        # Saving evaluation results to a numpy file
        import numpy as np
        np.save('evaluation_results.npy', [average_precisions, inference_time, precision_recall])
